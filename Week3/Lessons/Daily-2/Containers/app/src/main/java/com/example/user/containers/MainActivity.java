...
public class MainActivity extends AppCompatActivity {
    ...
    private void populateRecycleView() {
        ...
        RVBookAdapter adapter = new RVBookAdapter(DataCreator.getBookList(15));
    ...
    private void populateBookListView() {
        ...
        LVBookAdapter adapter = new LVBookAdapter(this, R.layout.book_list_item, DataCreator.getBookList(3));
        lvBooks.setAdapter(adapter);
    }

    private void populateSimpleListView() {
        ListView lvSimple = findViewById(R.id.lvSimple);
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<>(this, android.R.layout.simple_list_item_1, DataCreator.getSimpleStrings(3));
