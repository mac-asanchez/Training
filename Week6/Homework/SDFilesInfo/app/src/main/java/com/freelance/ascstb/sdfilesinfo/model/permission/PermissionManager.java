package com.freelance.ascstb.sdfilesinfo.model.permission;
...
public class PermissionManager {
    public static final int MY_PERMISSION_REQUEST_EXTERNAL_STORAGE = 100;
    ...
    public void checkPermission(Callback callback) {
        ...
        if (ContextCompat.checkSelfPermission(context, currentPermission) != PackageManager.PERMISSION_GRANTED) {
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) context,
                ...
                // MY_PERMISSION_REQUEST_EXTERNAL_STORAGE is an
            ...
            callback.onPermissionResults(MY_PERMISSION_REQUEST_EXTERNAL_STORAGE, true);
        }
    }
