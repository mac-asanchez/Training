 ...
 */
package com.example.user.contentproviderapp.description;
...
import com.example.user.contentproviderapp.BaseActivity;
import com.example.user.contentproviderapp.Constants;
import com.example.user.contentproviderapp.R;
import com.example.user.contentproviderapp.lentitems.CPSampleActivity;
