...
public class LentItemListFragment extends ListFragment implements
   ...
   public Loader<Cursor> onCreateLoader(int loaderId, Bundle args) {
      if (getActivity() != null) {
         return new CursorLoader(getActivity(), LentItemsContract.Items.CONTENT_URI, LentItemsContract.Items.PROJECTION_ALL, null, null, LentItemsContract.Items.SORT_ORDER_DEFAULT);
      }
      else {
         return null;
      }
