 ...
 */
package com.example.user.contentproviderapp.provider;
...
import com.example.user.contentproviderapp.BuildConfig;
import com.example.user.contentproviderapp.provider.LentItemsProvider;
    ...
    public Cursor query(Uri uri, String[] projection, String selection,
        ...
        switch (URI_MATCHER.match(uri)) {
            ...
            case ITEM_ID:
                ...
                builder.appendWhere(LentItemsContract.Items._ID + " = "
            ...
            case ENTITY_ID:
                builder.setTables(DbSchema.LEFT_OUTER_JOIN_STATEMENT);
                // limit query to one row at most:
                builder.appendWhere(DbSchema.TBL_ITEMS + "." + LentItemsContract.Items._ID + " = " + uri.getLastPathSegment());
                useAuthorityUri = true;
                break;
            default:
                throw new IllegalArgumentException("Unsupported URI: " + uri);
